...
def ChiSqr_Two(Strain,mut,df_mut,df_Strain,CondState,OtherCondState):
        ...
        try:
            ...
            results_temp=pd.DataFrame([mut_list,nonMut_list],columns=['Strain','Strain Total','Mutation','Mutation Total','Has Mutation','Total','Very-Mild_Asymptomatic', 'Mild', 'Moderate', 'Very_Severe', 'Dead',CondState+" vs "+OtherCondState],"Does mutation increase severity") 
